My Sales Book (KaiOS) — Offline Sales & Cash Ledger for Micro-Merchants

My Sales Book is a KaiOS feature-phone app designed for cash-based micro-merchants who run daily business without bank tools, spreadsheets, or reliable internet. The app turns “cash + memory + paper notebook” into a simple digital routine: record sales and expenses quickly, track informal credit, view daily profit, send SMS reminders, and protect records with SMS-based backup.
...
✅ manifest.webapp has correct fields:

name, description, icons, launch_path
...
Create a developer account for the KaiOS store program you are using.
...
Provide permissions justification:

SMS permission only if you use SMS reminders/backup

Submit for review

Respond to review feedback

If rejected, address the specific policy or manifest issues
